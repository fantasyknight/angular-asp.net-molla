...
const _class = require("../../model/clsemployerprintingoption");
...
let strquery = _class.data.select(" and employerprintingoptionId = " + verb.employerprintingoptionId);
return { 'flag': true, 'query': strquery };
...
let verb = _class.data.masterData(request);
let strquery = _class.data.delete(verb.employerprintingoptionId);
