...
const _class = require("../../model/clsemployerworkingdaynhour");
...
let strquery = _class.data.select(" and employerworkingdaynhourId = " + verb.employerworkingdaynhourId);
return { 'flag': true, 'query': strquery };
...
let verb = _class.data.masterData(request);
let strquery = _class.data.delete(verb.employerworkingdaynhourId);
