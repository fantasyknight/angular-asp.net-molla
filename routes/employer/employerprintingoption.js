...
const _employerprintingoption = require("../../component/employerprintingoption");

router.post('/apiSelection/', function (request, response) {
    try {

        let strResult = _employerprintingoption.dbSelection(request, response);
...
router.post('/apiSelect/', function (request, response) {
    try {
        ...
        let strResult = _employerprintingoption.dbSelect(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiSelectAll/', function (request, response) {
    try {
        ...
        let strResult = _employerprintingoption.dbSelectAll(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiDelete/', async function (request, response) {
    try {
        ...
        let strResult = await _employerprintingoption.dbDelete(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiInsert/', async function (request, response) {
    try {
        ...
        let strResult = await _employerprintingoption.dbInsert(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiUpdate/', async function (request, response) {
    try {
        ...
        let strResult = await _employerprintingoption.dbUpdate(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
