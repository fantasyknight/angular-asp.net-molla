...
const _employerworkingdaynhour = require("../../component/employerworkingdaynhour");

router.post('/apiSelection/', function (request, response) {
    try {

        let strResult = _employerworkingdaynhour.dbSelection(request, response);
...
router.post('/apiSelect/', function (request, response) {
    try {
        ...
        let strResult = _employerworkingdaynhour.dbSelect(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiSelectAll/', function (request, response) {
    try {
        ...
        let strResult = _employerworkingdaynhour.dbSelectAll(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiDelete/', async function (request, response) {
    try {
        ...
        let strResult = await _employerworkingdaynhour.dbDelete(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiInsert/', async function (request, response) {
    try {
        ...
        let strResult = await _employerworkingdaynhour.dbInsert(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
...
router.post('/apiUpdate/', async function (request, response) {
    try {
        ...
        let strResult = await _employerworkingdaynhour.dbUpdate(request, response);
        let strFlag = strResult.flag;
        let strQuery = strResult.query;
